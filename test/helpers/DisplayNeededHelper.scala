...
trait DisplayNeededHelper {
  ...
  var displayNeededAllFalse: DisplayNeeded = DisplayNeeded(
  ...
  var displayNeededAllTrue: DisplayNeeded = DisplayNeeded(
  ...
  var displayNeededMixed: DisplayNeeded = DisplayNeeded(
    taxIsDisplayNeededFlag = true,
    interestIsDisplayNeededFlag = false,
    paymentIsDisplayNeededFlag = true,
    repayReallocIsDisplayNeededFlag = false
